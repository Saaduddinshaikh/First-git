...
export default function Home() {
  const cards = [
    { photo: "/imb.jpg", name: "Globe", description: "Beautiful Laptop." },
    { photo: "/imb.jpg", name: "Rocket", description: "Fast design." },
    { photo: "/imb.jpg", name: "Studio", description: "Creative space." },
  ...
  return (
    <div className="flex min-h-screen flex-col bg-zinc-50 font-sans dark:bg-black">
        <main className="flex flex-1 w-full flex-col bg-white dark:bg-black">
          <div className="w-full max-w-3xl mx-auto flex flex-col items-center justify-between py-32 px-6 sm:px-8">
